...
{ kana: "ライバル心に火が付いた。いざ尋常に勝負だ、お前ら！！", romaji: ["raibarusinnnihigatuita.izazinnzyounisyoubuda,omaera!!" , "raibarushinnihigatuita.izazinnzyounishoubuda,omaera!!"] },
    ...
    { kana: "ホームポジションは大切です。人差し指で打つのは初心者の証拠。", romaji:["ho-mupozisyonnhataisetudesu.hitossasiyubideutunohasyosinnsyanoysouko."] },
    { kana: "1+1=2だが、1+2=1だ。違うって?じゃあなんだよ。(こいつ...)", romaji: ["1+1=2daga,1+2=1da.tigautte?zyaananndayo."] }
    ]
  },

     practiceLuna: {
  timeLimit: 105, // より短く、瞬発力を求める設定
  sushiTimeLimit: 35,
  sushiList: [
    { kana: "夕暮れの空に浮かぶ雲が、まるで大きな羊のように見えた。", romaji: ["yuugurenosoraniukabukumoga,marudeookinahituzinoyounimieta."] },
    { kana: "javascriptはAI頼みだなあ、こんな長文を人間が打てるわけもないし", romaji: ["javascripthaaidanomidanaa,konnnatyoubunnwoninngenngauteruwakemonaisi"] }, 
    { kana: "焼きたてのパンの香りが、窓から差し込む朝の光とともに部屋いっぱいに広がる。", romaji: ["yakitatenopannnokaoriga,madokarasasikomuasanohikaritotomoniheyaippainihirogaru."] },
    { kana: "これらの文章は、ひらがな、カタカナ、漢字がバランスよく含まれているので、タイピングの練習にぴったりです。ゲームの難易度や雰囲気に合わせて、好きな文章を選んでみてください。", romaji: ["koreranobunnsyouha,hiragana,katakana,kannzigabarannsuyokuhukumareteirunode,taipinngunorennsyuunipittaridesu.ge-munonannidoyahunnikiniawasete,sukinabunnsyouwoeranndemitekudasai."] },
    { kana: "雨降って地固まる、困難を乗り越えた後は以前よりも強い絆が生まれる。", romaji: ["amehuttetikatamaru,konnnannwonorikoetaatohaizennyorimotuyoikizunagaumareru."] },
    { kana: "騒がしい... うせな！煙草(たばこ)の味が濁る", romaji: ["sawagasii...usena!tabakonoaziganigoru"] }, // 擬似言語
    { kana: "古代遺跡に隠された宝の地図には、誰も知らない秘密の道が記されていた。", romaji: ["kodaiisekinikakusaretatakaranotizuniha,daremosiranaihimitunomitigasirusareteita."] },
    { kana: "これらのアイデアを組み合わせて、難易度別に問題を分けてみるのもいいですね。たとえば、初級：日常単語、中級：四字熟語、上級：小説の冒頭といった感じです。", romaji: ["koreranoaideawokumiawasete,nannidobetunimonndaiwowaketemirunomoiidesune.tatoeba,syokyuu:nitizyoutanngo,tyuukyuu:yozizyukugo,zyoukyuu:syousetunoboutoutoittakannzidesu."] },
    { kana: "ご指摘ありがとうございます。確かに、コピー＆ペーストによる不正は、今回のタイピングゲームの課題点です。", romaji: 
["gositekiarigatougzaimasu.tasikani,kopi-&pe-sutoniyoruhuseiha,konnkainotaipinnguge-munokadaitenndesu."] },
    { kana: "これらのアイデアを元に、さらに独自の要素を加えてみるのも面白いかもしれません。例えば、マルチプレイヤー要素を追加して友達と対戦できるようにしたり、ランキング機能を導入してモチベーションを高めたりするのも効果的です。", romaji: ["koreranoaideawomotoni,saranidokuzinoyousowokuwaetemirunomoomosiroikamosiremasenn.tatoeba,marutipureiya-yousowotuikasitetomodatitotaisenndekiruyounisitari,rannkinngukinouwodounyuusitemoribe-syonnwotakametarisurunomokoukatekidesu."] }
...
function getTitle(difficulty) {
  switch (difficulty) {
    ...
    case "practiceLuna": return "あなたはSuperLunaticもクリアできます。";
